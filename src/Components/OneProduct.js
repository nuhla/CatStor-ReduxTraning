    ...
    <div className="card">
      ...
      <div className="card-body">
        <h5 className="card-title">
          10 Beautiful Opening Lines of Books Will Remind You What Fantastic
          Writing Looks Like
        </h5>
        <p className="card-text">
          It's a truth universally acknowledged: An author's first line can make
          or break a book. Celebrated texts are often identified not only by
          their memorable characters, but by their legendary...
        </p>
        <a
